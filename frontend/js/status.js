...
// Проверка по URL
// Отправляет URL на /api/uptime/check и показывает результат
...
// Вызывается при загрузке и затем каждые 30 секунд
