"""
Простая проверка всех API-эндпоинтов NetworkUtils.
Использование:
    python test_api.py                          # локально
    python test_api.py https://networkutils.mooo.com  # прод
"""
...
check("md5 присутствует",                    "md5" in data, data.get("md5", "")[:8])
